...
void TextureManager::Init()
{
	...
	LoadTexture(RESOURCE_PATH::TEXTURES, "skybox.png");	
	LoadTexture(RESOURCE_PATH::TEXTURES, "skybox2.png");	
	LoadTexture(RESOURCE_PATH::TEXTURES, "health.jpeg");	
	LoadTexture(RESOURCE_PATH::TEXTURES, "fuel.jpeg");	
